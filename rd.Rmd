...
functions from the <code><a href = 'https://cran.r-project.org/web/packages/glmnet/index.html'>glmnet</a></code>
...
Parallelization is executed using <code><a href = http://pnnl.github.io/docs-Smisc/rd.html#parlapplyw>parLapplyW</a></code>
from the <code><a href = http://pnnl.github.io/docs-Smisc>Smisc</a></code> package.</dd>
  <dt>estimateLoss</dt>
...
<code>newdata</code> must contain all of the column names that were used
...
the <code>print</code>, <code>coef</code>, <code>predict</code>, and <code>extract</code> methods, the "..." are ignored.</dd>
</dl>
...
from <code>data.frame</code>) that contains the predicted class for each observation.  The columns indicated
by <code>truthCol</code> and <code>keepCols</code> are included if they were requested.</p>
